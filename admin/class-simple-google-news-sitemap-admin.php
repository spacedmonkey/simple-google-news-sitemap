...
class Simple_Google_News_Sitemap_Admin {
	...
	/**
	 * Add in the settings in the admin terminal
	 */
	...
	/**
	 * Markup for the dropdown of categories
	 */
	public function settings_markup() {
		$value = get_option( $this->plugin_name, array( 'sgns_category' => 0 ) );
		wp_dropdown_categories( array(
				'show_option_all' => __( 'Show all categories', 'simple-google-news-sitemap' ),
				'hide_empty'      => 0,
				'selected'        => $value['sgns_category'],
				'name'            => $this->plugin_name . '[sgns_category]'
			) );
	}
